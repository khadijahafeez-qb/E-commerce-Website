...
-- AlterTable
ALTER TABLE "public"."Product" DROP COLUMN "colour",
DROP COLUMN "price",
DROP COLUMN "size",
DROP COLUMN "stock",
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductVariant_productId_colour_size_key" ON "public"."ProductVariant"("productId", "colour", "size");
