...
// | Case                             | Covered | Notes                       |
// | -------------------------------- | ------- | --------------------------- |
// | ✅ User not found (safe response) | ✔️      | Security best practice      |
// | ✅ Valid user → token + email     | ✔️      | Main happy path             |
// | ✅ sendMail fails                 | ✔️      | Should return 500           |
// | ✅ prisma.update fails            | ✔️      | Should return 500           |
// | ✅ Invalid JSON                   | ✔️      | Should return 500           |
// | ✅ Missing NEXT_PUBLIC_APP_URL    | ✔️      | Still works due to fallback |
